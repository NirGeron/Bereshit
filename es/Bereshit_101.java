...
//			}
			...
			if(alt >2000 ){
			...
			}else if(alt<2000 && alt>1000) {	// maintain a vertical speed of [20-25] m/s
				if(vs >20) {
					if(ang<20){
						ang+=2;
					}
				...
				if(vs <15) {
					...
					NN-=0.003*dt;}// less power for braking
				}else if(alt<1000 && alt>500) {	// maintain a vertical speed of [20-25] m/s
					if(vs >15) {
						if(ang<10){
							ang+=2;
						}
			...
			// lower than 2 km - horizontal speed should be close to zero
				...
				if(ang>2) {ang-=2;} // rotate to vertical position.
				else {ang =0;}
